...
The default `config/config.yaml` file may be used as template for configuration, but should be further modified. The example `config/samples.tsv` should also be replaced.
